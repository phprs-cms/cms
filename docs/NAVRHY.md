...
Hotovo: 1, 2, 4, 5, 6, 8, 9, 11, 13, 14, 18, 20, 21, 24, 25, 29, 31, 32, 37, 38, 39, 40, 41, 44, 47; částečně 7 (video z adresy ano, příspěvky ze sítí ne), 12 (porovnání verzí ano, ukládání konceptu na server ne) a 23 (obnova ano,
vzdálené zálohy ne).

Další v pořadí: více autorů u článku (3), ukládání rozepsaného článku na server
a porovnání revizí (12), zálohy mimo server (23), platební brána (15),
