...
Článek můžete vyhradit přihlášeným čtenářům nebo předplatitelům. Ostatní uvidí titulek, perex, začátek textu a výzvu. Předplatné systém neprodává ani neúčtuje – platbu přijmete po svém a předplatné čtenáři zapíšete ručně.
...
V **Nastavení → Základní** rozbalte oddíl **Čtenáři a zamčený obsah**:
...
| **Kde získat předplatné** | kam vede tlačítko **Získat předplatné** | prázdné |
| **Text výzvy pod ukázkou** | vlastní věta ve výzvě, nejvýše 300 znaků; prázdné = výchozí text | prázdné |

## Kde získat předplatné

Do pole **Kde získat předplatné** zadejte jednu z možností:
...
Jiný tvar adresy se ignoruje. Dokud pole nevyplníte, tlačítko **Získat předplatné** se nezobrazí – ani u zamčených článků, ani v účtu čtenáře – a čtenář neví, jak se předplatitelem stát. Obrazovka **Příjmy** na to upozorní hlášením **Není vyplněno, kde čtenář předplatné získá.**

## Zápis předplatného

Předplatné se zapisuje ručně, typicky po přijetí platby.
