...
phpRS je redakční systém pro internetové magazíny, noviny a blogy. Tato příručka vás provede od instalace po běžný provoz.

Je psaná pro tři druhy čtenářů. **Redakce** – lidé, kteří píší, upravují a vydávají – najde, co potřebuje, v kapitolách o psaní a redakci.
**Správce webu a vydavatel** – ten, kdo systém nainstaloval, stará se o něj a rozhoduje o vzhledu, čtenářích a příjmech – začne kapitolami Začínáme a Provoz
a pokračuje kapitolami Vzhled až SEO a AI. **Vývojář** najde mapu kódu a pravidla projektu v kapitole Pro vývojáře.
...
- **Pro vývojáře** – struktura projektu, zásady, testy a vydávání, jak přispět.
