...
- **Telefon mit der Authentifizierungs-App verloren** – geben Sie statt des Codes einen der Ersatzcodes ein. Wenn Sie keine haben, schaltet ein anderer Administrator Ihre Zwei-Faktor-Anmeldung aus: **Verwaltung → Benutzer** → Ihr Konto → **Detaillierte Einstellungen** → Zeile **Zwei-Faktor-Anmeldung**.
