...
Den Dunkelmodus für Leser schalten Sie an derselben Stelle ein – die Website richtet sich dann nach der Einstellung ihres Geräts.

## 2. Legen Sie Ressorts an

**Inhalt → Ressorts.** Jeder Artikel gehört zu genau einem Ressort, ohne Ressort lässt sich ein Artikel nicht speichern. Die Installation hat das Ressort *Aktuelles* angelegt (mit Beispielinhalten die fünf Ressorts einer erfundenen Tageszeitung); benennen Sie es um und fügen Sie weitere hinzu.
Ressorts können Unterressorts haben. Die Reihenfolge in der Navigation bestimmt das Feld **Reihenfolge**.
...
## 4. Stellen Sie die Seite zusammen

**Design → Blöcke und Layout.** Ihre Website öffnet sich im Bearbeitungsmodus. Blöcke – Liste der Ressorts, meistgelesene Artikel, Suche, eigener Text und weitere – fügen Sie mit der Schaltfläche **+ Block hinzufügen** direkt an der Stelle ein, an der sie stehen sollen, und verschieben sie mit der Maus. Oben wählen Sie das Layout: drei Spalten, zwei, eine oder volle Breite.
...
- **Zwei-Faktor-Anmeldung** bei allen Administratoren (**Mein Konto**).
- **Einstellungen → Systemstatus** – gehen Sie die Punkte mit Ausrufezeichen durch. Bei jedem steht, was nicht stimmt und wo Sie es beheben.
- **Sicherungen außerhalb des Servers** (**Einstellungen → Sicherungen und Aktualisierungen**) – eine Sicherung auf demselben Server wie die Website hilft nicht, wenn Sie das Hosting verlieren.
- **Weitere Personen in der Redaktion** – **Verwaltung → Benutzer**. Ein Autor schreibt und schickt zur Korrektur, ein Redakteur veröffentlicht, ein Administrator verwaltet die gesamte Website.
...
Das Tastenkürzel **Strg+K** (auf dem Mac **⌘K**) öffnet die Befehlspalette: Tippen Sie den Namen eines Bereichs, einer Aktion oder eines Artikels und drücken Sie Enter. Das funktioniert auch ohne Umlaute und Sonderzeichen.
