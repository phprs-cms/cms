/* phpRS 3 - pomocník editoru článků: kontrola přístupnosti obsahu a AI asistent. Bez knihoven.
 *
...
(function () {
	...
	function nastav(id, hodnota) {
		var p = pole(id);
		p.value = hodnota;
		if (window.phprsEditory && window.phprsEditory[id]) { window.phprsEditory[id].obnov(); }
