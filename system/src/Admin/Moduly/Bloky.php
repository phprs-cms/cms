...
final class Bloky extends Modul
{
    ...
    public const array KATALOG = [
        'Články' => [
            'otv' => ['Otvírák', 'Velká upoutávka na připnutý nebo nejnovější článek.', '★'],
            'cla' => ['Články z rubriky', 'Seznam posledních článků z rubriky, kterou vyberete.', '☰'],
            'nej' => ['Nejčtenější', 'Žebříček článků podle počtu přečtení.', '▲'],
            'sti' => ['Štítky', 'Nejpoužívanější štítky jako odkazy.', '#'],
            'arc' => ['Archiv', 'Články po měsících.', '▦'],
            'aut' => ['Autoři', 'Seznam autorů s počtem článků.', '☺'],
        ],
        'Navigace' => [
            'rub' => ['Rubriky', 'Seznam rubrik webu.', '▤'],
            'men' => ['Menu', 'Vlastní odkazy – na stránky webu i jinam.', '≡'],
            'str' => ['Stránky', 'Odkazy na stránky jako O nás a Kontakt.', '▢'],
            'hle' => ['Vyhledávání', 'Pole pro hledání v článcích.', '⌕'],
        ],
        'Čtenáři a redakce' => [
        ...
        'Vlastní' => [
            '' => ['Text', 'Vlastní text, obrázek nebo vložený kód (video, mapa…).', '¶'],
            'rek' => ['Reklama', 'Pozice, na které se střídají bannery z Reklamního systému.', '◫'],
        ],
    ];
    ...
    protected function akceUlozJson(): Response
    {
        ...
        $this->db->update('bloky', $data, ['idb' => $id]);
        \PhpRS\Admin\Protokol::zapis($this->app, 'bloky', 'uloz', (string) $data['nazev']);
