...
use PhpRS\Core\ExportWebu;
use PhpRS\Core\Jazyk;
use PhpRS\Core\Response;
use PhpRS\Core\StahovaniObrazku;
use PhpRS\Core\WpImport;
use PhpRS\Core\WpSoubor;
...
final class Prenos extends Modul
{
    ...
    protected function akceNahled(): Response
    {
        ...
        return $this->view('nahled', 'Import z WordPressu', [
            ...
            'presmerovaniZapnuto' => \PhpRS\Core\Rozsireni::je($nastaveni, 'presmerovani'),
        ]);
    }
    ...
    protected function akceSpust(): Response
    {
        ...
        $stav['volby'] = [
            ...
            'koncepty' => $r->postBool('koncepty'), 'stranky' => $r->postBool('stranky'), 'komentare' => $r->postBool('komentare'),
