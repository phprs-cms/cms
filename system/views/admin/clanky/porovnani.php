<?php
/**
 * Porovnání uložené verze článku se současným zněním.
 *
...
<p class="navigace-radek">
	...
	<a class="navigace" href="<?= e($modul->url('revize', ['id' => (int) $clanek['idc'], 'idr' => (int) $revize['idr']])) ?>"><?= e(t('Načíst tuto verzi do editoru')) ?></a>
</p>
