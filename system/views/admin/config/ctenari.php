...
<p class="hlaska hlaska-varovani"><?= PhpRS\Admin\Cesty::odkazy($app->url('admin.php'), t('Účty čtenářů, zamčený obsah a předplatné jsou vypnuté. Zapnete je v sekci Rozšíření; nastavení níže se použije potom.'), ['rozsireni']) ?></p>
<?php endif ?>
<fieldset>
...
$stripeHotovo = PhpRS\Core\Stripe::nastaveno($app->settings());
?>
</fieldset>
<fieldset>
...
<div class="radek">
	...
	<span class="napoveda"><?= e(t('Tuto adresu zadejte ve Stripe → Developers → Webhooks a zapněte události:')) ?> <code><?= e(implode(', ', PhpRS\Core\Stripe::UDALOSTI)) ?></code></span></div>
</div>
<?php
