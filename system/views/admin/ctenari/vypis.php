...
<thead><tr><th><?= e(t('E-mail')) ?></th><th><?= e(t('Jméno')) ?></th><th><?= e(t('Registrace')) ?></th><th><?= e(t('Naposledy')) ?></th><th><?= e(t('Předplatné')) ?></th><th><?= e(t('Akce')) ?></th></tr></thead>
<tbody>
...
<?php endif ?>
	...
	<td class="akce"><form method="post" action="<?= e($modul->url('smaz')) ?>" style="display:inline" data-potvrdit="Smazat účet čtenáře <?= e($c['email']) ?>?"><?= $csrf ?><input type="hidden" name="idct" value="<?= (int) $c['idct'] ?>"><button class="navigace" type="submit"><?= e(t('Smaž')) ?></button></form></td>
</tr>
<?php endforeach ?>
</tbody></table></div>
<?php endif ?>
