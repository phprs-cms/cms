...
<div class="radek"><label for="soubor"><?= e(t('Export z WordPressu')) ?></label><div><input type="file" id="soubor" name="soubor" accept=".xml,text/xml,application/xml" required>
	<span class="napoveda"><?= e(t('Server dovolí nahrát nejvýš %s. Větší soubor zkopírujte přes FTP do složky storage/import/ – objeví se v seznamu níže.', PhpRS\Core\Soubory::velikost($limitNahrani))) ?></span></div></div>
...
<tr>
	<td><?= e($s['soubor']) ?></td>
	<td class="cislo"><?= e(PhpRS\Core\Soubory::velikost($s['velikost'])) ?></td>
...
<tr>
	<td><?= e($x['soubor']) ?></td>
	<td class="cislo"><?= e(PhpRS\Core\Soubory::velikost($x['velikost'])) ?></td>
