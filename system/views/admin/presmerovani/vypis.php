...
<?= $csrf ?>
<div class="radek"><label for="z_adresy">Stará adresa</label><div><input class="textpole siroke" type="text" id="z_adresy" name="z_adresy" maxlength="255" required placeholder="/stara-stranka.html"><span class="napoveda">Cesta na tomto webu, která už neexistuje.</span></div></div>
...
<div class="tab-obal">
<table class="vypis">
<thead><tr><th>Stará adresa</th><th>Cíl</th><th>Použito</th><th>Vytvořeno</th><th>Akce</th></tr></thead>
<tbody>
...
<tr>
	...
	<td class="akce"><form method="post" action="<?= e($modul->url('smaz')) ?>" style="display:inline"><?= $csrf ?><input type="hidden" name="idp" value="<?= (int) $z['idp'] ?>"><button class="navigace" type="submit">Smaž</button></form></td>
</tr>
<?php endforeach ?>
</tbody>
</table>
