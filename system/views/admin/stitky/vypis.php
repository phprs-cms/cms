<?php
/**
 * @var PhpRS\Admin\Moduly\Stitky $modul
 ...
 */
?>
<p class="smltxt"><?= e(t('Štítky vznikají samy při psaní článků. Když štítku doplníte popis a obrázek, stane se z jeho stránky téma – úvod ke kauze, volbám nebo festivalu se všemi články na jednom místě.')) ?></p>
<?php if ($uprav !== null): ?>
...
<div class="radek"><label for="popis"><?= e(t('Úvod tématu')) ?></label><div><textarea class="textbox" id="popis" name="popis" rows="5" data-editor="maly"><?= e((string) $uprav['popis']) ?></textarea><span class="napoveda"><?= e(t('Nepovinné. Zobrazí se nad výpisem článků a jako popis pro vyhledávače.')) ?></span></div></div>
...
</select><span class="napoveda"><?= e(t('Články dostanou vybraný štítek, tento zanikne a jeho adresa se přesměruje. Hodí se na překlepy a dvojí psaní.')) ?></span></div></div>
</details>
</fieldset>
