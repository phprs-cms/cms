...
<div class="radek pres-celou">
	<label for="titulek">Název stránky</label>
...
<div class="radek">
	<label for="seo_link">Adresa</label>
	<div><input class="textpole siroke" type="text" id="seo_link" name="seo_link" value="<?= e($stranka['seo_link']) ?>" maxlength="110" placeholder="vytvoří se z názvu, např. o-nas"><?= $chyba('seo_link') ?></div>
</div>
<div class="radek">
	<label for="popis">Popis pro vyhledávače</label>
...
<div class="radek">
	...
	<div class="volby">
		<label><input type="checkbox" name="zobrazit" value="1"<?= $stranka['zobrazit'] ? ' checked' : '' ?>> Zveřejnit stránku</label><br>
		<label><input type="checkbox" name="v_menu" value="1"<?= $stranka['v_menu'] ? ' checked' : '' ?>> Odkaz v navigaci webu (patička)</label>
	</div>
</div>
<div class="radek">
	<label for="poradi">Pořadí v navigaci</label>
	<input class="textpole" type="number" id="poradi" name="poradi" value="<?= (int) $stranka['poradi'] ?>" min="0" max="65535" style="width:90px">
</div>
