...
<div class="radek">
	<label for="nazev">Název rubriky</label>
...
<div class="radek">
	<label for="seo_link">Adresa rubriky</label>
	<div><input class="textpole siroke" type="text" id="seo_link" name="seo_link" value="<?= e($rubrika['seo_link']) ?>" maxlength="110" placeholder="vytvoří se z názvu"></div>
</div>
<div class="radek">
	<label for="id_predka">Nadřazená rubrika</label>
	<div><select id="id_predka" name="id_predka">
		<option value="0">- žádná (hlavní rubrika) -</option>
...
<div class="radek">
	...
	<span class="napoveda">Zobrazí se nad výpisem článků rubriky a použije se jako meta description.</span></div>
</div>
<div class="radek">
	<label for="obrazek">Obrázek (ikona) rubriky</label>
	<input class="textpole siroke" type="text" id="obrazek" name="obrazek" value="<?= e($rubrika['obrazek']) ?>" maxlength="255" placeholder="nepovinné, adresa obrázku">
</div>
<div class="radek">
	<label for="hodnost">Pořadí</label>
