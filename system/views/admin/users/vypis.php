 ...
 */
?>
<p class="navigace-radek"><a class="navigace" href="<?= e($modul->url('novy')) ?>">Nový uživatel</a></p>
<div class="tab-obal">
<table class="vypis">
<thead><tr><th>Uživatel</th><th>Jméno</th><th>E-mail</th><th>Role</th><th>Vydává</th><th>Článků</th><th>Poslední přihlášení</th><th>Akce</th></tr></thead>
<tbody>
...
<tr<?= $a['blokovat'] ? ' class="nevydany"' : '' ?>>
	...
	<td class="stred"><?= (int) $a['admin'] >= PhpRS\Core\Auth::REDAKTOR || $a['pravo_vydavat'] ? 'Ano' : 'Ne' ?></td>
