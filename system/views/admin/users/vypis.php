...
<div class="tab-obal">
<table class="vypis">
<thead><tr><th scope="col"><?= e(t('Uživatel')) ?></th><th scope="col"><?= e(t('Jméno')) ?></th><th scope="col"><?= e(t('E-mail')) ?></th><th scope="col"><?= e(t('Role')) ?></th><th scope="col"><?= e(t('Vydává')) ?></th><th scope="col"><?= e(t('Článků')) ?></th><th scope="col"><?= e(t('Poslední přihlášení')) ?></th><th scope="col"><?= e(t('Akce')) ?></th></tr></thead>
<tbody>
...
<?php if ((int) $a['idu'] !== $app->auth()->id()): ?>
		/ <form class="vradku" method="post" action="<?= e($modul->url('smaz')) ?>" data-potvrdit="<?= e(t('Opravdu smazat uživatele? Jeho články zůstanou zachované bez autora.')) ?>"><?= $csrf ?><input type="hidden" name="idu" value="<?= (int) $a['idu'] ?>"><button class="navigace nebezpecne" type="submit"><?= e(t('Smazat')) ?></button></form>
<?php endif ?>
	</td>
</tr>
<?php endforeach ?>
