<?php
/**
 * Vestavěná cookie lišta. Souhlas se ukládá do cookie "phprs_souhlas" na 6 měsíců.
...
(function () {
	...
	function precti() { var m = document.cookie.match(/(?:^|; )phprs_souhlas=([^;]*)/); return m ? decodeURIComponent(m[1]).split(',') : null; }
