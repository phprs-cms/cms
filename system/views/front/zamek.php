...
<?php if ($predplatne && ($predplatneUrl ?? '') !== ''): ?>
	<p><a class="rs-tl" href="<?= e($predplatneUrl) ?>"><?= e(t('Získat předplatné')) ?></a><?php if (!$prihlasen): ?> <a class="rs-tl rs-tl-vedlejsi" href="<?= e($ucet) ?>"><?= e(t('Už předplatné mám – přihlásit se')) ?></a><?php endif ?></p>
