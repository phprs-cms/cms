 ...
 *
 * Prostředí: PHPRS_SNIMKY_CIL = adresa instance (http://localhost:8080), PHPRS_SNIMKY_COOKIE = "phprs3=…".
 */

declare(strict_types=1);

$cil = rtrim((string) getenv('PHPRS_SNIMKY_CIL'), '/');
...
curl_setopt_array($ch, [
    ...
    CURLOPT_HTTPHEADER => ['Cookie: ' . getenv('PHPRS_SNIMKY_COOKIE'), 'Accept: ' . ($_SERVER['HTTP_ACCEPT'] ?? '*/*'), 'Accept-Language: ' . ($_SERVER['HTTP_ACCEPT_LANGUAGE'] ?? 'cs')],
]);
