...
for m in clanky "clanky&akce=novy" "clanky&akce=kalendar" intergal topic stitky stranky news comment ankety stat reklama newsletter ctenari vzhled "bloky&schema=1" users presmerovani protokol; do over "modul $m" 200 "/admin.php?modul=$m"; done
